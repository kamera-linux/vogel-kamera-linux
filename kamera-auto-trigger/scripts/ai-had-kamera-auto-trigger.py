...
parser.add_argument('--trigger-threshold', type=float, default=0.38, help='AI-Schwelle für Trigger (default: 0.38, optimiert für CPU-Limit)')
parser.add_argument('--preview-fps', type=int, default=5, help='FPS für Monitoring-Modus (default: 5, Balance zwischen Performance und CPU-Last)')
parser.add_argument('--preview-width', type=int, default=480, help='Breite für Monitoring-Vorschau (default: 480, Balance zwischen Erkennungsqualität und CPU)')
parser.add_argument('--preview-height', type=int, default=360, help='Höhe für Monitoring-Vorschau (default: 360, Balance zwischen Erkennungsqualität und CPU)')
