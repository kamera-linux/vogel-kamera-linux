...
parser.add_argument('--preview-width', type=int, default=320, help='Breite für Monitoring-Vorschau (default: 320, optimiert für CPU)')
parser.add_argument('--preview-height', type=int, default=240, help='Höhe für Monitoring-Vorschau (default: 240, optimiert für CPU)')
