...
- Version: v2.0.1
- Wichtige Änderungen: Cinema 4K (4096x2160 @ 25fps), AI-HAD Audio-Modus, verbesserte CLI-Parameter (normal/slowmo/4k/ai-had), robustere SSH-Log-Verfolgung und automatische Video-Synchronisation nach Konvertierung.
- Sicherheits- & Stabilitätsfixes: ISO-Wochenkorrektur (%V), Pfad-Extraktion gefixt, automatische SSH-Wiederverbindung, Behebung eines pipefail-bedingten Skript-Abbruchs.

Für vollständige Details siehe: [`releases/RELEASE_NOTES_v2.0.1.md`](../../releases/RELEASE_NOTES_v2.0.1.md)
